...
public interface StateMachine<T extends StateMachine<T, S, E, C>, S, E, C> extends Visitable, Observable
{
	...
	interface StateMachineListener<T extends StateMachine<T, S, E, C>, S, E, C>
	{
		...
		public static final Method METHOD = ReflectUtils.getMethod( StateMachineListener.class, METHOD_NAME,
				new Class<?>[] { StateMachineEvent.class } );
	...
	interface StartListener<T extends StateMachine<T, S, E, C>, S, E, C>
	{
		...
		public static final Method METHOD = ReflectUtils.getMethod( StartListener.class, METHOD_NAME,
				new Class<?>[] { StartEvent.class } );
	...
	interface TerminateListener<T extends StateMachine<T, S, E, C>, S, E, C>
	{
		...
		public static final Method METHOD = ReflectUtils.getMethod( TerminateListener.class, METHOD_NAME,
				new Class<?>[] { TerminateEvent.class } );
	...
	interface StateMachineExceptionListener<T extends StateMachine<T, S, E, C>, S, E, C>
	{
		...
		public static final Method METHOD = ReflectUtils.getMethod( StateMachineExceptionListener.class, METHOD_NAME,
				new Class<?>[] { StateMachineExceptionEvent.class } );
	...
	interface TransitionBeginListener<T extends StateMachine<T, S, E, C>, S, E, C>
	{
		...
		public static final Method METHOD = ReflectUtils.getMethod( TransitionBeginListener.class, METHOD_NAME,
				new Class<?>[] { TransitionBeginEvent.class } );
	...
	interface TransitionCompleteListener<T extends StateMachine<T, S, E, C>, S, E, C>
	{
		...
		public static final Method METHOD = ReflectUtils.getMethod( TransitionCompleteListener.class, METHOD_NAME,
				new Class<?>[] { TransitionCompleteEvent.class } );
	...
	interface TransitionExceptionListener<T extends StateMachine<T, S, E, C>, S, E, C>
	{
		...
		public static final Method METHOD = ReflectUtils.getMethod( TransitionExceptionListener.class, METHOD_NAME,
				new Class<?>[] { TransitionExceptionEvent.class } );
	...
	interface TransitionDeclinedListener<T extends StateMachine<T, S, E, C>, S, E, C>
	{
		...
		public static final Method METHOD = ReflectUtils.getMethod( TransitionDeclinedListener.class, METHOD_NAME,
				new Class<?>[] { TransitionDeclinedEvent.class } );
	...
	interface TransitionEndListener<T extends StateMachine<T, S, E, C>, S, E, C>
	{
		...
		public static final Method METHOD = ReflectUtils.getMethod( TransitionEndListener.class, METHOD_NAME,
				new Class<?>[] { TransitionEndEvent.class } );
