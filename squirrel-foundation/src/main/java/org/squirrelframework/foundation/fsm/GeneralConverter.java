...
public class GeneralConverter<T> implements Converter<T>
{
	...
	public T convertFromString(String value)
	{
		...
		if (type.equals( boolean.class ) || type.equals( Boolean.class ))
		{
			...
			if (Number.class.isAssignableFrom( type ) || int.class.isAssignableFrom( type ) || long.class.isAssignableFrom( type )
		...
		throw new IllegalStateException( "Unable to convert type: '" + type.getName() + "' with value '" + value + "'." );
	}
