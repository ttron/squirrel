...
public class MethodCallActionImpl<T extends StateMachine<T, S, E, C>, S, E, C> implements Action<T, S, E, C>
{
	...
	@Override
	public void execute(final S from, final S to, final E event, final C context, final T stateMachine)
	{
	...
	public boolean equals(Object obj)
	{
		...
		if (obj instanceof MethodCallActionProxyImpl && obj.equals( this ))
			return true;
		if (getClass() != obj.getClass() || !method.equals( MethodCallActionImpl.class.cast( obj ).method ))
			return false;
		return true;
	}
