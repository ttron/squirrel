...
abstract class FSM
{
	...
	static <T extends StateMachine<T, S, E, C>, S, E, C> StateContext<T, S, E, C> newStateContext(
			StateMachine<T, S, E, C> stateMachine, StateMachineData<T, S, E, C> data, ImmutableState<T, S, E, C> sourceState,
			E event, C context, TransitionResult<T, S, E, C> result, ActionExecutionService<T, S, E, C> executor)
	{
	...
	static <T extends StateMachine<T, S, E, C>, S, E, C> MutableState<T, S, E, C>
			getState(Map<S, MutableState<T, S, E, C>> states, S stateId)
	{
	...
	static <T extends StateMachine<T, S, E, C>, S, E, C> MultiTransitionBuilder<T, S, E, C> newMultiTransitionBuilder(
			Map<S, MutableState<T, S, E, C>> states, TransitionType transitionType, int priority,
	...
	static <T extends StateMachine<T, S, E, C>, S, E, C> ExternalTransitionBuilder<T, S, E, C>
			newExternalTransitionBuilder(Map<S, MutableState<T, S, E, C>> states, int priority, ExecutionContext executionContext)
	{
	...
	static <T extends StateMachine<T, S, E, C>, S, E, C> LocalTransitionBuilder<T, S, E, C>
			newLocalTransitionBuilder(Map<S, MutableState<T, S, E, C>> states, int priority, ExecutionContext executionContext)
	{
		return SquirrelProvider.getInstance().newInstance( new TypeReference<TransitionBuilderImpl<T, S, E, C>>()
		{
		}, new Class[] { Map.class, TransitionType.class, int.class, ExecutionContext.class },
	...
	static <T extends StateMachine<T, S, E, C>, S, E, C> InternalTransitionBuilder<T, S, E, C>
			newInternalTransitionBuilder(Map<S, MutableState<T, S, E, C>> states, int priority, ExecutionContext executionContext)
	{
		return SquirrelProvider.getInstance().newInstance( new TypeReference<TransitionBuilderImpl<T, S, E, C>>()
		{
		}, new Class[] { Map.class, TransitionType.class, int.class, ExecutionContext.class },
	...
	static <T extends StateMachine<T, S, E, C>, S, E, C> EntryExitActionBuilder<T, S, E, C>
			newEntryExitActionBuilder(MutableState<T, S, E, C> state, boolean isEntryAction, ExecutionContext executionContext)
	{
	...
	static <T extends StateMachine<T, S, E, C>, S, E, C> MethodCallActionImpl<T, S, E, C> newMethodCallAction(Method method,
			int weight, ExecutionContext executionContext)
	{
		return SquirrelProvider.getInstance().newInstance( new TypeReference<MethodCallActionImpl<T, S, E, C>>()
		{
		}, new Class[] { Method.class, int.class, ExecutionContext.class }, new Object[] { method, weight, executionContext } );
	}


	static <T extends StateMachine<T, S, E, C>, S, E, C> MethodCallActionProxyImpl<T, S, E, C>
			newMethodCallActionProxy(String methodName, ExecutionContext executionContext)
	{
	...
	static <T extends StateMachine<T, S, E, C>, S, E, C> MethodReferenceActionImpl<T, S, E, C>
			newMethodReferenceAction(MethodReference<T, S, E, C> methodReference)
	{
	...
	static <T extends StateMachine<T, S, E, C>, S, E, C> TransitionResult<T, S, E, C> newResult(boolean accepted,
			ImmutableState<T, S, E, C> targetState, TransitionResult<T, S, E, C> parent)
	{
	...
	static <T extends StateMachine<T, S, E, C>, S, E, C> Action<T, S, E, C> newMvelAction(String expression,
			ExecutionContext executionContext)
	{
	...
	static <T extends StateMachine<T, S, E, C>, S, E, C> StateMachineData<T, S, E, C>
			newStateMachineData(Map<S, ? extends ImmutableState<T, S, E, C>> states)
	{
		return SquirrelProvider.getInstance().newInstance( new TypeReference<StateMachineData<T, S, E, C>>()
		{
