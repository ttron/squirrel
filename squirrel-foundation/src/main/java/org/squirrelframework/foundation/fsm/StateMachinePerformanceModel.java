...
public class StateMachinePerformanceModel
{
	...
	public String toString()
	{
		...
		builder.append( "Average Transition Comsumed: " ).append( String.format( "%.4fms", averageTransitionConsumedTime ) )
				.append( "\n" );
		...
		builder.append( "Average Action Execution Comsumed: " ).append( String.format( "%.4fms", averageActionConsumedTime ) )
				.append( "\n" );
		...
		for ( String aKey : actionInvokeTimes.keySet() )
		{
			builder.append( "\t" ).append( StringUtils.abbreviateMiddle( aKey, "...", 15 ) ).append( "\t\t" )
					...
					.append( maxActionConsumedTime.get( aKey ) ).append( "ms\t\t" ).append( minActionConsumedTime.get( aKey ) )
					.append( "ms\t\t" );
			builder.append( "\n" );
		}
