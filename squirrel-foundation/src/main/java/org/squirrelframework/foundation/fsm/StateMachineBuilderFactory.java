...
public class StateMachineBuilderFactory
{
	...
	{
		final StateMachineBuilder<UntypedStateMachine, Object, Object, Object> builder = create( stateMachineClazz, Object.class,
				Object.class, Object.class, extraConstParamTypes );
		return create( builder );
	}


	public static UntypedStateMachineBuilder
			create(final StateMachineBuilder<UntypedStateMachine, Object, Object, Object> builder)
	{
		return (UntypedStateMachineBuilder) Proxy.newProxyInstance( UntypedStateMachineBuilder.class.getClassLoader(),
				new Class[] { UntypedStateMachineBuilder.class }, new InvocationHandler()
				{
					@Override
					public Object invoke(Object proxy, Method method, Object[] args) throws Throwable
					{
						try
						{
							...
							if (methodName.equals( "newUntypedStateMachine" ) || methodName.equals( "newAnyStateMachine" ))
							{
								...
								{
									fsmInstance = builder.newStateMachine( args[0], (StateMachineConfiguration) args[1],
											(Object[]) args[2] );
								}
								else
									if (args.length == 2 && (args[1] == null || args[1].getClass().isArray()))
									{
	...
	public static <T extends StateMachine<T, S, E, C>, S, E, C> StateMachineBuilder<T, S, E, C>
			create(Class<? extends T> stateMachineClazz, Class<S> stateClazz, Class<E> eventClazz, Class<C> contextClazz)
	{
