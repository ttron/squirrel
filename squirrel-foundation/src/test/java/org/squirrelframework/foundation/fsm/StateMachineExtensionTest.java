...
public class StateMachineExtensionTest extends AbstractStateMachineTest
{
	...
	@Transitions({ @Transit(from = "A", to = "B", on = "ToB", callMethod = "testAToBOnToB"),
	...
	@States({ @State(name = "A", exitCallMethod = "beforeExitA"), @State(name = "A", exitCallMethod = "afterExitA"),
			@State(name = "B", entryCallMethod = "beforeEntryB") })
	@Transitions({ @Transit(from = "B", to = "C", on = "ToC"),
	...
	public void setup()
	{
		...
		StateMachineBuilder<DeclarativeStateMachine, TestState, TestEvent, Integer> builder = StateMachineBuilderFactory
				.<DeclarativeStateMachine, TestState, TestEvent, Integer> create( StateMachineImpl.class, TestState.class,
